...
def newCust():
    ...
    def confirm():
        ...
        if cust_name=="" or cust_phone=="" or cust_email=="":
            ...
            try:
                con = mysql.connect(host="localhost", user="root", password="Browser$123", database="billing_user")
                cursor = con.cursor()
    ...
    lbmain = Label(root, text='Supermarket Billing System', font='Montserrat 40 bold', bg='#002f42', fg='white',
                   pady=20)
    ...
    confirm = Button(root, text='Confirm', image=picConfirm, compound=LEFT, fg='#002f42', borderwidth=0,
                     highlightbackground='#5ce1e6', font='arial 25', width=250, command=confirm)
    confirm.place(x=250, y=530)
    reset = Button(root, text='Reset', image=picReset, compound=LEFT, fg='#002f42', borderwidth=0,
                   highlightbackground='#5ce1e6', font='arial 25', width=250, command=reset)
...
def deleteCust():
    ...
    lbmain = Label(root, text='Supermarket Billing System', font='Montserrat 50 bold',bg='#002f42', fg='white', pady=20).place(x=270, y=15)

    canvas=Canvas(root, width=900, highlightthickness=0, height=3, bg='white')
    canvas.place(x=150,y=110)

    lbsub = Label(root, text='Delete Customer', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=450, y=165)

    lbPhoneNo = Label(root, text='Phone Number :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=250, y=265)
    ...
    btnsearch.place(x=900, y=260)

    canvas2=Canvas(root, width=700, highlightthickness=0, height=3, bg='#54bec7').place(x=220, y=320)

    lbname = Label(root, text='Customer Name :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=262, y=340)
    txtname = Label(root, width=30, font='Montserrat 20 bold', bg='#95a2aa', highlightthickness=0, fg='black')
    txtname.place(x=480, y=345)
    lbemail = Label(root, text='Email ID :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=340, y=420)
    txtemail = Label(root, width=30, font='Montserrat 20 bold', bg='#95a2aa', highlightthickness=0, fg='black')
...
def updateCust():
    ...
    lbsub = Label(root, text='Update Customer', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=450, y=165)
    ...
    lbname = Label(root, text='Customer Name :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=230, y=340)
    txtname = Entry(root, width=30, font='Montserrat 20 bold', bg='#95a2aa', highlightthickness=0, fg='black')
    txtname.place(x=480, y=345)
    lbemail = Label(root, text='Email ID :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=330, y=420)
...
def viewCust():
    ...
    lbmain = Label(root, text='Supermarket Billing System', font='Montserrat 50 bold',bg='#002f42', fg='white', pady=20).place(x=270, y=15)
    lbsub = Label(root, text='Customer Details', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=400, y=130)
    ...
    btn_customer_Search.place(x=850, y=190)

    canvas1=Canvas(root, width=980, highlightthickness=0, height=3, bg='#70d0e5')
    canvas1.place(x=60,y=240)

    lbname = Label(root, text='Customer Name :', font='Montserrat 25 bold',bg='#002f42', fg='white').place(x=70, y=260)
    lbemail = Label(root, text='Email ID :', font='Montserrat 25 bold',bg='#002f42', fg='white').place(x=600, y=260)

    txtname = Label(root, width=20, font='Montserrat 20 bold', bg='#95a2aa', fg='black')
    txtname.place(x=292, y=265)
    txtemail = Label(root, width=20, font='Montserrat 20 bold', bg='#95a2aa', fg='black')
    txtemail.place(x=720, y=265)

    TableFrame = Frame(root,bg="#002f42",width=800,height=350)
    TableFrame.place(x=260,y=335)
...
def newProd():
    ...
    lbmain = Label(root, text='Supermarket Billing System', font='Montserrat 50 bold',bg='#002f42', fg='white', pady=20).place(x=270, y=15)
    lbsub = Label(root, text='New Product', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=450, y=165)

    canvas=Canvas(root, width=900, highlightthickness=0, height=3, bg='white')
    canvas.place(x=150,y=110)

    id = Label(root, text='Product ID :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=300, y=265)
    id_entry = Label(root, width=30, font='Montserrat 20 bold', bg='white', fg='black', highlightthickness=0)
    id_entry.place(x=480, y=265)
    name = Label(root, text='Product Name :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=255, y=340)
    name_entry = Entry(root, width=30, font='Montserrat 20 bold', bg='white', highlightthickness=0)
    name_entry.place(x=480, y=345)
    price = Label(root, text='Price :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=360, y=420)
...
def deleteProd():
    ...
    lbsub = Label(root, text='Delete Product', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=450, y=165)

    lbProductID = Label(root, text='Product ID :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=310, y=265)
    ...
    lbProductName = Label(root, text='Product Name :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=262, y=340)
    ...
    lbePrice = Label(root, text='Price :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=370, y=420)
    txtPrice = Label(root, width=30, font='Montserrat 20 bold', bg='#95a2aa', highlightthickness=0, fg='black')
    txtPrice.place(x=480, y=420)
...
def updateProd():
    ...
    lbsub = Label(root, text='Update Product', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=450, y=165)

    lbProductID = Label(root, text='Product ID :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=300, y=265)
    txtProductID = Entry(root, width=30, font='Montserrat 20 bold', bg='white', fg='black', highlightthickness=0)
    txtProductID.place(x=480, y=265)
    ...
    lbName = Label(root, text='Product Name :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=250, y=340)
    txtName = Entry(root, width=30, font='Montserrat 20 bold', bg='#95a2aa', highlightthickness=0, fg='black')
    txtName.place(x=480, y=345)
    lbPrice = Label(root, text='Price ID :', fg='white', bg='#002f42', font='Montserrat 25 bold').place(x=330, y=420)
...
def viewProd():
    ...
    lbmain = Label(root, text='Supermarket Billing System', font='Montserrat 50 bold',bg='#002f42', fg='white', pady=20).place(x=270, y=15)
    lbsub = Label(root, text='View Product Details', font='Montserrat 35 bold', bg='#002f42', fg='#54bec7').place(x=400, y=130)
    ...
    refresh = Button(root, text='Refresh', image=picRefresh, compound= LEFT, fg='#002f42', borderwidth=0, highlightbackground='#5ce1e6', font='arial 25', width=250, command=refresh)
    refresh.place(x=440, y=630)
...
lbmain.place(x=150, y=10)
lbhome = Label(root, text='- HOME', font='Montserrat 30 bold',bg='#002f42', fg='#70d0e5')
lbhome.place(x=860, y=35)
...
lbnewCust = Label(cust, text = "New Customer", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbupdateCust = Label(cust, text = "Update Customer Details", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbdeleteCust = Label(cust, text = "Delete Customer", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbviewCust = Label(cust, text = "View Customer Details", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbnewProd = Label(prod, text = "New Product", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbupdateProd = Label(prod, text = "Update Product Details", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbdeleteProd = Label(prod, text = "Delete Product", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
...
lbviewProd = Label(prod, text = "View Product Details", bg='#002f42', font='Montserrat 30 bold', fg = 'white')
lbviewProd.place(x=480, y=110)


billing = Button(root, text='    Billing Page', image=picbill, compound= LEFT, fg='#002f42', highlightbackground='#70d0e5', borderwidth=2, font='Montserrat 30 bold', width=300, command = bill)
billing.place(x=375, y=580)

logout = Button(root, image=piclogout, highlightbackground='#002f42', width=225, height=40, command = logout)
logout.place(x=800, y=620)
lblogout = Label(root, text = 'Logout', font='Montserrat 30 bold', fg = 'white', bg = '#54bec7')
lblogout.place(x=890,y=620)
